            ...
            >
              <nav className="absolute top-0 left-0 w-full flex justify-between items-center px-6 md:px-10 h-24 z-50 bg-transparent">              
                ...
                <div className="hidden md:flex space-x-10 text-[10px] font-medium uppercase tracking-[0.3em]">
                  <a href="#" className="font-body font-medium text-[10px] tracking-[0.3em] uppercase text-white">Collection</a>
                  <a href="#" className="font-body font-medium text-[10px] tracking-[0.3em] uppercase text-white">Archive</a>
                  <a href="#" className="font-body font-medium text-[10px] tracking-[0.3em] uppercase text-white">Contact</a>
                </div>

                <div className="flex-1 flex justify-end space-x-6 items-center">
                  <button className="font-body font-medium text-[10px] tracking-[0.3em] uppercase text-white">Search</button>
                  <a href="/cart" className="flex items-center gap-2 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="group-hover:text-red-600 transition-all text-white">
              ...
              {/* AQUÍ: Botón Flotante Global de WhatsApp */}
              <a
